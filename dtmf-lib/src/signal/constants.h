...
constexpr int	DEBOUNCE			= (DURATION + PAUSE) * 1;						// Default debounce value [ms] (default = 90% of DURATION + PAUSE)
...
const int		freqThresholds[8]	= { 1000,  1000,  1000,  1000,  1000,  1000,  1000,  1000 };