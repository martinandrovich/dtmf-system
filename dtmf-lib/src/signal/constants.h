...
constexpr int	DEBOUNCE			= (DURATION + PAUSE) * 0.7;						// Defallt debounce value [ms] (default = 90% of DURATION + PAUSE)
constexpr auto	FADE				= 0.20f;										// Default signal fade percentage [decimal] (0.1 = 10%)
...
const int		freqThresholds[8]	= { 800,  800,  800,  800,  800,  800,  800,  800 };