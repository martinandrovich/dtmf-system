...
int main() {
	...
	std::cout << "Total time = " << totalTime.count() << std::endl << std::endl;
	...
	std::cout << std::setw(5) << std::left << "Bomb" << std::setw(2) << std::left << "|" << std::setw(7) << std::left << durationsBomb.size() << std::setw(2) << std::left << "|" << std::setw(22) << std::left << shortestDur(durationsBomb) << std::setw(2) << std::left << "|" << std::setw(10) << std::left << averageDur(durationsBomb) << std::endl;
	std::cout << std::setw(5) << std::left << "Up" << std::setw(2) << std::left << "|" << std::setw(7) << std::left << durationsUp.size() << std::setw(2) << std::left << "|" << std::setw(22) << std::left << shortestDur(durationsUp) << std::setw(2) << std::left << "|" << std::setw(10) << std::left << averageDur(durationsUp) << std::endl;
	std::cout << std::setw(5) << std::left << "Down" << std::setw(2) << std::left << "|" << std::setw(7) << std::left << durationsDown.size() << std::setw(2) << std::left << "|" << std::setw(22) << std::left << shortestDur(durationsDown) << std::setw(2) << std::left << "|" << std::setw(10) << std::left << averageDur(durationsDown) << std::endl;
	std::cout << std::setw(5) << std::left << "Right" << std::setw(2) << std::left << "|" << std::setw(7) << std::left << durationsRight.size() << std::setw(2) << std::left << "|" << std::setw(22) << std::left << shortestDur(durationsRight) << std::setw(2) << std::left << "|" << std::setw(10) << std::left << averageDur(durationsRight) << std::endl;
	std::cout << std::setw(5) << std::left << "Left" << std::setw(2) << std::left << "|" << std::setw(7) << std::left << durationsLeft.size() << std::setw(2) << std::left << "|" << std::setw(22) << std::left << shortestDur(durationsLeft) << std::setw(2) << std::left << "|" << std::setw(10) << std::left << averageDur(durationsLeft) << std::endl;
	...
	std::cout << std::setw(5) << std::left << "" << std::setw(2) << std::left << "|" << std::setw(7) << std::left << totalCount << std::setw(2) << std::left << "|" << std::setw(22) << std::left << shortestDur(inputDelta) << std::setw(2) << std::left << "|" << std::setw(10) << std::left << averageDur(inputDelta) << std::endl << std::endl;
